...
SECRET_KEY = 'django-insecure-qxsoe9o^f1w^a^r+)5vr9defo+h*6k!2rbp@ptg1l*21-30p$-'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(REAL_BASE_DIR, 'frontend', 'react_build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(REAL_BASE_DIR, 'frontend', 'react_build', 'static')]
